 ...
 * NomeCrime
 */
public class Prender extends javax.swing.JFrame {
    ...
    public Prender() {
        ...
        jPanel8.setBackground(new java.awt.Color(13, 32, 64));
            ...
            if(paser==o.getInt("id_usuario")){
                ...
                */
                ...
                for(int i3 = 0; i3 < procuradosDBarray.length(); i3++){
                    ...
                    int tornozer = oproc.getInt("tornz");
                    ...
                    if(pass==oproc.getInt("id_usuario")){
                        if(pagou <= 0){
                            if(meseer > 0 || multaar > 0 || tornozer > 0){
                ...
                if(player_procurado){
                    procuradoTxt.setText("SIM");
                    procuradoTxt.setForeground(new java.awt.Color(255,51,51));
                    procuradoBt.setEnabled(true);
                }else{
                    procuradoTxt.setText("NÃO");
                    procuradoTxt.setForeground(new java.awt.Color(51,153,0));
                ...
                if(player_procurado){
                    ...
                    jLabel20.setText(NivelPr.toUpperCase());
                    jLabel20.setForeground(new java.awt.Color(255,51,51));
                }else{
                    if(o.getInt("lspd") == 1){
                        jLabel20.setText(config.Abv_NomePolicia);
    ...
    public boolean AtualizarCrimes(){
        int maxmeses = 60; //Máximo de meses preso
        int maxmeses2 = 1000; //Máximo de meses com tornozeleira
        ...
        if(desacato){
            ...
            Beneficios+=" // Desacato [REVOGADO TODAS AS REDUÇÕES +25%]";
            descontor=contadesa;
        }else{
        ...
        if(check3.isSelected()){descontor+=-((valormeses*30)/100);Beneficios+=" // Cúmplice [-30%]";                }//50% da pena
        if(check4.isSelected()){descontor+=-((valormeses*10)/100);Beneficios+=" // Confessou crime [-10%]";         }//-10%
        if(check5.isSelected()){descontor+=-((valormeses*10)/100);Beneficios+=" // Colaborou [-10%]";               } //-50%
        if(check6.isSelected()){descontor+=-((valormeses*10)/100);Beneficios+=" // Negociação com advogado [-10%]"; } //-10%
        ...
        if(" //".equals(Beneficios))Beneficios="";
        ...
        String torntxtrevert = "";
        String TornFormat;
        int tornmeses = 0;
        if(valormeses > 0){
            tornmeses=valormeses*5;
            TornFormat = (tornmeses == 1) ? "mês" : "meses";
            torntxtrevert=" // [REVERTIDO: "+valormeses+" "+MesesFormat+" preso em "+tornmeses+" "+TornFormat+" de tornozeleira]";
            if(valormeses > maxmeses){
                valormeses=valormeses-maxmeses;
            }else{
                valormeses=0;
            }
        }
        ...
        if(tornmeses>maxmeses2)tornmeses=maxmeses2;
        ...
        CrimesDB+=" //// Meses com Tornozeleira: "+tornmeses+torntxtrevert+" // Meses Preso: "+maximor+" // Multa Total: "+MultaFormat;//+addmesese;
        String Crimi = "Nenhuma";
        if(CrimesTxt.length() <= 0){
            crimes.setText("Nenhum crime cometido !");
            CrimesTxt="Nenhuma";
        }else{
            if(valormeses > 0 || valormulta > 0 || tornmeses > 0){
                Crimi=CrimesDB;
                if(PassaPreso!=0){
                    if(valormeses > 0){
                        registrar.setText("GUARDAR REGISTRO DE PRISÃO");
                    }else if(tornmeses > 0){
                        registrar.setText("GUARDAR REGISTRO DE TORNOZELEIRA");
                    }else{
                        registrar.setText("GUARDAR REGISTRO DE MULTA");
                    }
                    registrar.setEnabled(true);
                    guardar_procurado.setEnabled(true);
                }
            }
        }
        ...
        boolean preso = false;
        boolean multa = false;
        if(tornmeses>0)tornz=true;
        if(valormeses>0)preso=true;
        if(valormulta>0)multa=true;
        
        tornrpresor=tornmeses;
        meserpresor=valormeses;
        multapresor=valormulta;
        
        TornFormat = (tornmeses == 1) ? "mês" : "meses";
        TornFormat = tornmeses+" "+TornFormat;
        
        /*if(preso && multa && tornz){
            Fzeroq = "Prender por "+MesesFormat+", Tornozeleira por "+TornFormat+" e Multar em "+MultaFormat;
            //Comandos="/prender "+ID+" "+valormeses+" e /multar -> "+ID+" -> "+valormulta;
        }*/
        if(valormeses > 0){
            Fzeroq = "Prender por "+MesesFormat;
            //Comandos="/prender "+ID+" "+valormeses;
        }
        if(tornmeses > 0){
            if(!"".equals(Fzeroq))Fzeroq+=", ";
            Fzeroq+= "Tornozeleira "+TornFormat;
            //Comandos="/prender "+ID+" "+valormeses;
        }
        if(valormulta > 0){ //   ||
            if(!"".equals(Fzeroq))Fzeroq+=", ";
            Fzeroq+= "Multar em "+MultaFormat;
            //Comandos="/multar -> "+ID+" -> "+valormulta;
        }
        
        if("".equals(Fzeroq))Fzeroq= "Nada a Fazer, Libere o Cidadão";
        fazeroq.setText(Fzeroq);
        comandos.setText(Comandos);
        
        String getMax = (valormeses >= maxmeses) ? "[Máx]" : "";
        String getMax2 = (tornmeses >= maxmeses2) ? "[Máx]" : "";
        String TextDiscord = ""//"```\n"
                + "Nome: "+Nome+"\n"
                + "Passaporte: "+ID+"\n"
    ...
    public void MensagemDiscord(JSONObject DiscordTag){
        ...
        if(OqH != 0){
            ...
            eb.setTitle(config.NomePolicia+" - Registro "+protocolo, null);
            eb.setColor(new Color(0x0D2040));
            eb.setDescription(":rotating_light: Você "+ApreendiT+" **"+config.NomePolicia+"**!");
    ...
    private void initComponents() {
        ...
        verpreso1 = new javax.swing.JButton();
        ...
        guardar_procurado = new javax.swing.JButton();
        ...
        txtA14 = new javax.swing.JLabel();
        numero11 = new javax.swing.JTextField();
        zerar11 = new javax.swing.JButton();
        jSeparator7 = new javax.swing.JSeparator();
        txtA19 = new javax.swing.JLabel();
        numero12 = new javax.swing.JTextField();
        txtA20 = new javax.swing.JLabel();
        numero16 = new javax.swing.JTextField();
        zerar16 = new javax.swing.JButton();
        txtA21 = new javax.swing.JLabel();
        numero17 = new javax.swing.JTextField();
        txtA22 = new javax.swing.JLabel();
        txtA23 = new javax.swing.JLabel();
        numero18 = new javax.swing.JTextField();
        numero13 = new javax.swing.JTextField();
        zerar18 = new javax.swing.JButton();
        zerar13 = new javax.swing.JButton();
        jSeparator8 = new javax.swing.JSeparator();
        numero19 = new javax.swing.JTextField();
        numero14 = new javax.swing.JTextField();
        zerar19 = new javax.swing.JButton();
        zerar14 = new javax.swing.JButton();
        jSeparator13 = new javax.swing.JSeparator();
        txtA24 = new javax.swing.JLabel();
        txtA25 = new javax.swing.JLabel();
        numero20 = new javax.swing.JTextField();
        numero15 = new javax.swing.JTextField();
        zerar20 = new javax.swing.JButton();
        zerar15 = new javax.swing.JButton();
        jSeparator14 = new javax.swing.JSeparator();
        txtA26 = new javax.swing.JLabel();
        txtA27 = new javax.swing.JLabel();
        zerar12 = new javax.swing.JButton();
        zerar17 = new javax.swing.JButton();
        ...
        txtA52 = new javax.swing.JLabel();
        numero53 = new javax.swing.JTextField();
        menos53 = new javax.swing.JButton();
        mais53 = new javax.swing.JButton();
        zerar53 = new javax.swing.JButton();
        jSeparator26 = new javax.swing.JSeparator();
        txtA53 = new javax.swing.JLabel();
        menos54 = new javax.swing.JButton();
        numero54 = new javax.swing.JTextField();
        mais54 = new javax.swing.JButton();
        zerar54 = new javax.swing.JButton();
        txtA54 = new javax.swing.JLabel();
        menos57 = new javax.swing.JButton();
        numero57 = new javax.swing.JTextField();
        mais57 = new javax.swing.JButton();
        zerar57 = new javax.swing.JButton();
        txtA55 = new javax.swing.JLabel();
        menos58 = new javax.swing.JButton();
        numero58 = new javax.swing.JTextField();
        mais58 = new javax.swing.JButton();
        zerar58 = new javax.swing.JButton();
        txtA56 = new javax.swing.JLabel();
        txtA57 = new javax.swing.JLabel();
        menos59 = new javax.swing.JButton();
        menos55 = new javax.swing.JButton();
        numero59 = new javax.swing.JTextField();
        numero55 = new javax.swing.JTextField();
        mais59 = new javax.swing.JButton();
        mais55 = new javax.swing.JButton();
        zerar59 = new javax.swing.JButton();
        zerar55 = new javax.swing.JButton();
        jSeparator27 = new javax.swing.JSeparator();
        menos56 = new javax.swing.JButton();
        numero56 = new javax.swing.JTextField();
        mais56 = new javax.swing.JButton();
        zerar56 = new javax.swing.JButton();
        jSeparator28 = new javax.swing.JSeparator();
        txtA59 = new javax.swing.JLabel();
        ...
        procuradoTxt = new javax.swing.JLabel();
        ...
        verpreso1.setBackground(new java.awt.Color(13, 32, 64));
        verpreso1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/police/imagens/searchbt.png"))); // NOI18N
        verpreso1.setBorder(null);
        verpreso1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        verpreso1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                verpreso1ActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(verpreso1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(id)
                    .addComponent(verpreso1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(10, 10, 10))
        );
        ...
        crimes.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N

        multatotal.setEditable(false);
        multatotal.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        mesestotal.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        fazeroq.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        comandos.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        copiar1.setBackground(new java.awt.Color(255, 255, 255));
        ...
        guardar_procurado.setBackground(new java.awt.Color(255, 255, 255));
        guardar_procurado.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        guardar_procurado.setText("GUARDAR COMO PROCURADO");
        guardar_procurado.setEnabled(false);
        guardar_procurado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                guardar_procuradoActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(guardar_procurado, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(copiar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(guardar_procurado, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "BENEFÍCIOS / MALEFÍCIOS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel5.setForeground(new java.awt.Color(255, 255, 255));

        check3.setBackground(new java.awt.Color(50, 31, 87));
        check3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check3.setForeground(new java.awt.Color(255, 255, 255));
        check3.setText("CÚMPLICE");
        ...
        check4.setBackground(new java.awt.Color(50, 31, 87));
        check4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check4.setForeground(new java.awt.Color(255, 255, 255));
        check4.setText("CONFESSOU CRIME");
        ...
        check5.setBackground(new java.awt.Color(50, 31, 87));
        check5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check5.setForeground(new java.awt.Color(255, 255, 255));
        check5.setText("COLABOROU EM TUDO");
        ...
        check6.setBackground(new java.awt.Color(50, 31, 87));
        check6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check6.setForeground(new java.awt.Color(255, 255, 255));
        check6.setText("NEGOC. ADVOGADO");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(check5, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(check3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(check6, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        txtA14.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA14.setForeground(new java.awt.Color(255, 255, 255));
        txtA14.setText("ITEM ILEGAL:");

        numero11.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero11.setText("0");
        numero11.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero11KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero11KeyTyped1(evt);
            }
        });

        zerar11.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar11.setText("0");
        zerar11.setEnabled(false);
        zerar11.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar11.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar11.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar11.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar11ActionPerformed(evt);
            }
        });

        txtA19.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA19.setForeground(new java.awt.Color(255, 255, 255));
        txtA19.setText("LOCKPICK:");
        txtA19.setEnabled(false);

        numero12.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero12.setText("0");
        numero12.setEnabled(false);
        numero12.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero12KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero12KeyTyped(evt);
            }
        });

        txtA20.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA20.setForeground(new java.awt.Color(255, 255, 255));
        txtA20.setText("DROGAS:");

        numero16.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero16.setText("0");
        numero16.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero16KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero16KeyTyped(evt);
            }
        });

        zerar16.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar16.setText("0");
        zerar16.setEnabled(false);
        zerar16.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar16.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar16.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar16.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar16.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar16ActionPerformed(evt);
            }
        });

        txtA21.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA21.setForeground(new java.awt.Color(255, 255, 255));
        txtA21.setText("DINHEIRO SUJO:");

        numero17.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero17.setText("0");
        numero17.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero17KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero17KeyTyped(evt);
            }
        });

        txtA22.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA22.setForeground(new java.awt.Color(255, 255, 255));
        txtA22.setText("LOG DE BANCO:");

        txtA23.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA23.setForeground(new java.awt.Color(255, 255, 255));
        txtA23.setText("MASTERPICK:");
        txtA23.setEnabled(false);

        numero18.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero18.setText("0");
        numero18.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero18KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero18KeyTyped(evt);
            }
        });

        numero13.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero13.setText("0");
        numero13.setEnabled(false);
        numero13.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero13KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero13KeyTyped(evt);
            }
        });

        zerar18.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar18.setText("0");
        zerar18.setEnabled(false);
        zerar18.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar18.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar18.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar18.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar18.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar18ActionPerformed(evt);
            }
        });

        zerar13.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar13.setText("0");
        zerar13.setEnabled(false);
        zerar13.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar13.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar13.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar13.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar13ActionPerformed(evt);
            }
        });

        numero19.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero19.setText("0");
        numero19.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero19KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero19KeyTyped(evt);
            }
        });

        numero14.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero14.setText("0");
        numero14.setEnabled(false);
        numero14.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero14KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero14KeyTyped(evt);
            }
        });

        zerar19.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar19.setText("0");
        zerar19.setEnabled(false);
        zerar19.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar19.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar19.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar19.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar19.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar19ActionPerformed(evt);
            }
        });

        zerar14.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar14.setText("0");
        zerar14.setEnabled(false);
        zerar14.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar14.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar14.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar14.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar14.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar14ActionPerformed(evt);
            }
        });

        txtA24.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA24.setForeground(new java.awt.Color(255, 255, 255));
        txtA24.setText("ORGÃOS:");

        txtA25.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA25.setForeground(new java.awt.Color(255, 255, 255));
        txtA25.setText("PENDRIVE:");
        txtA25.setEnabled(false);

        numero20.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero20.setText("0");
        numero20.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero20KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero20KeyTyped(evt);
            }
        });

        numero15.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero15.setText("0");
        numero15.setEnabled(false);
        numero15.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                numero15KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numero15KeyTyped(evt);
            }
        });

        zerar20.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar20.setText("0");
        zerar20.setEnabled(false);
        zerar20.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar20.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar20.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar20.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar20.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar20ActionPerformed(evt);
            }
        });

        zerar15.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar15.setText("0");
        zerar15.setEnabled(false);
        zerar15.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar15.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar15.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar15.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar15.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar15ActionPerformed(evt);
            }
        });

        txtA26.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA26.setForeground(new java.awt.Color(255, 255, 255));
        txtA26.setText("MUNIÇÕES:");

        txtA27.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA27.setForeground(new java.awt.Color(255, 255, 255));
        txtA27.setText("CAPUZ:");
        txtA27.setEnabled(false);

        zerar12.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar12.setText("0");
        zerar12.setEnabled(false);
        zerar12.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar12.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar12.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar12.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar12ActionPerformed(evt);
            }
        });

        zerar17.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar17.setText("0");
        zerar17.setEnabled(false);
        zerar17.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar17.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar17.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar17.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar17.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar17ActionPerformed(evt);
            }
        });
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txtA19, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero12, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar12, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtA21, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero17, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txtA14, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero11, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar11, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtA20, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero16, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar16, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jSeparator8)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txtA23, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero13, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar13, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, Short.MAX_VALUE)
                        .addComponent(txtA22, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero18, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jSeparator13)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txtA25, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero14, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar14, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtA24, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero19, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar19, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jSeparator14)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txtA27, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero15, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar15, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtA26, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero20, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar20, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA14)
                    .addComponent(numero11, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar11, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA20)
                    .addComponent(numero16, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar16, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtA21)
                    .addComponent(numero17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar12, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA23)
                    .addComponent(numero13, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar13, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA22)
                    .addComponent(numero18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA25)
                    .addComponent(numero14, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar14, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA24)
                    .addComponent(numero19, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar19, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA27)
                    .addComponent(numero15, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar15, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA26)
                    .addComponent(numero20, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar20, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        txtA52.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA52.setForeground(new java.awt.Color(255, 255, 255));
        txtA52.setText("HOMICÍDIO DOLOSO:");

        numero53.setEditable(false);
        numero53.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero53.setText("0");
        numero53.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero53ActionPerformed(evt);
            }
        });

        menos53.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos53.setText("<");
        menos53.setEnabled(false);
        menos53.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos53.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos53.setMaximumSize(new java.awt.Dimension(21, 21));
        menos53.setMinimumSize(new java.awt.Dimension(21, 21));
        menos53.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos53ActionPerformed(evt);
            }
        });

        mais53.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais53.setText(">");
        mais53.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais53.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais53.setMaximumSize(new java.awt.Dimension(21, 21));
        mais53.setMinimumSize(new java.awt.Dimension(21, 21));
        mais53.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais53ActionPerformed(evt);
            }
        });

        zerar53.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar53.setText("0");
        zerar53.setEnabled(false);
        zerar53.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar53.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar53.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar53.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar53.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar53ActionPerformed(evt);
            }
        });

        txtA53.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA53.setForeground(new java.awt.Color(255, 255, 255));
        txtA53.setText("HOMICÍDIO CULPOSO:");

        menos54.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos54.setText("<");
        menos54.setEnabled(false);
        menos54.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos54.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos54.setMaximumSize(new java.awt.Dimension(21, 21));
        menos54.setMinimumSize(new java.awt.Dimension(21, 21));
        menos54.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos54ActionPerformed(evt);
            }
        });

        numero54.setEditable(false);
        numero54.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero54.setText("0");
        numero54.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero54ActionPerformed(evt);
            }
        });

        mais54.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais54.setText(">");
        mais54.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais54.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais54.setMaximumSize(new java.awt.Dimension(21, 21));
        mais54.setMinimumSize(new java.awt.Dimension(21, 21));
        mais54.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais54ActionPerformed(evt);
            }
        });

        zerar54.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar54.setText("0");
        zerar54.setEnabled(false);
        zerar54.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar54.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar54.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar54.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar54.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar54ActionPerformed(evt);
            }
        });

        txtA54.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        txtA54.setForeground(new java.awt.Color(255, 255, 255));
        txtA54.setText("TENT. HOM. Á POLICIAL:");

        menos57.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos57.setText("<");
        menos57.setEnabled(false);
        menos57.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos57.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos57.setMaximumSize(new java.awt.Dimension(21, 21));
        menos57.setMinimumSize(new java.awt.Dimension(21, 21));
        menos57.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos57ActionPerformed(evt);
            }
        });

        numero57.setEditable(false);
        numero57.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero57.setText("0");
        numero57.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero57ActionPerformed(evt);
            }
        });

        mais57.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais57.setText(">");
        mais57.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais57.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais57.setMaximumSize(new java.awt.Dimension(21, 21));
        mais57.setMinimumSize(new java.awt.Dimension(21, 21));
        mais57.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais57ActionPerformed(evt);
            }
        });

        zerar57.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar57.setText("0");
        zerar57.setEnabled(false);
        zerar57.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar57.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar57.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar57.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar57.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar57ActionPerformed(evt);
            }
        });

        txtA55.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        txtA55.setForeground(new java.awt.Color(255, 255, 255));
        txtA55.setText("HOMICÍDIO Á POLICIAL:");

        menos58.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos58.setText("<");
        menos58.setEnabled(false);
        menos58.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos58.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos58.setMaximumSize(new java.awt.Dimension(21, 21));
        menos58.setMinimumSize(new java.awt.Dimension(21, 21));
        menos58.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos58ActionPerformed(evt);
            }
        });

        numero58.setEditable(false);
        numero58.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero58.setText("0");
        numero58.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero58ActionPerformed(evt);
            }
        });

        mais58.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais58.setText(">");
        mais58.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais58.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais58.setMaximumSize(new java.awt.Dimension(21, 21));
        mais58.setMinimumSize(new java.awt.Dimension(21, 21));
        mais58.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais58ActionPerformed(evt);
            }
        });

        zerar58.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar58.setText("0");
        zerar58.setEnabled(false);
        zerar58.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar58.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar58.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar58.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar58.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar58ActionPerformed(evt);
            }
        });

        txtA56.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA56.setForeground(new java.awt.Color(255, 255, 255));
        txtA56.setText("GENOCÍDIO:");

        txtA57.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        txtA57.setForeground(new java.awt.Color(255, 255, 255));
        txtA57.setText("TENTATIVA DE HOMIC.:");

        menos59.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos59.setText("<");
        menos59.setEnabled(false);
        menos59.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos59.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos59.setMaximumSize(new java.awt.Dimension(21, 21));
        menos59.setMinimumSize(new java.awt.Dimension(21, 21));
        menos59.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos59ActionPerformed(evt);
            }
        });

        menos55.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos55.setText("<");
        menos55.setEnabled(false);
        menos55.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos55.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos55.setMaximumSize(new java.awt.Dimension(21, 21));
        menos55.setMinimumSize(new java.awt.Dimension(21, 21));
        menos55.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos55ActionPerformed(evt);
            }
        });

        numero59.setEditable(false);
        numero59.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero59.setText("0");
        numero59.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero59ActionPerformed(evt);
            }
        });

        numero55.setEditable(false);
        numero55.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero55.setText("0");
        numero55.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero55ActionPerformed(evt);
            }
        });

        mais59.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais59.setText(">");
        mais59.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais59.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais59.setMaximumSize(new java.awt.Dimension(21, 21));
        mais59.setMinimumSize(new java.awt.Dimension(21, 21));
        mais59.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais59ActionPerformed(evt);
            }
        });

        mais55.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais55.setText(">");
        mais55.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais55.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais55.setMaximumSize(new java.awt.Dimension(21, 21));
        mais55.setMinimumSize(new java.awt.Dimension(21, 21));
        mais55.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais55ActionPerformed(evt);
            }
        });

        zerar59.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar59.setText("0");
        zerar59.setEnabled(false);
        zerar59.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar59.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar59.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar59.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar59.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar59ActionPerformed(evt);
            }
        });

        zerar55.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar55.setText("0");
        zerar55.setEnabled(false);
        zerar55.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar55.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar55.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar55.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar55.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar55ActionPerformed(evt);
            }
        });

        menos56.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        menos56.setText("<");
        menos56.setEnabled(false);
        menos56.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        menos56.setMargin(new java.awt.Insets(1, 2, 1, 2));
        menos56.setMaximumSize(new java.awt.Dimension(21, 21));
        menos56.setMinimumSize(new java.awt.Dimension(21, 21));
        menos56.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menos56ActionPerformed(evt);
            }
        });

        numero56.setEditable(false);
        numero56.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        numero56.setText("0");
        numero56.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numero56ActionPerformed(evt);
            }
        });

        mais56.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        mais56.setText(">");
        mais56.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        mais56.setMargin(new java.awt.Insets(1, 2, 1, 2));
        mais56.setMaximumSize(new java.awt.Dimension(21, 21));
        mais56.setMinimumSize(new java.awt.Dimension(21, 21));
        mais56.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mais56ActionPerformed(evt);
            }
        });

        zerar56.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        zerar56.setText("0");
        zerar56.setEnabled(false);
        zerar56.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        zerar56.setMargin(new java.awt.Insets(1, 2, 1, 2));
        zerar56.setMaximumSize(new java.awt.Dimension(21, 21));
        zerar56.setMinimumSize(new java.awt.Dimension(21, 21));
        zerar56.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                zerar56ActionPerformed(evt);
            }
        });

        txtA59.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtA59.setForeground(new java.awt.Color(255, 255, 255));
        txtA59.setText("LATROCÍNIO:");
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(txtA57, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero55, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtA56, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero59, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(txtA59, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero56, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(txtA53, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero54, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtA55, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero58, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(txtA52, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero53, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtA54, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(menos57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(numero57, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mais57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(zerar57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA52)
                    .addComponent(numero53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar53, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA54)
                    .addComponent(numero57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar57, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA53)
                    .addComponent(numero54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar54, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA55)
                    .addComponent(numero58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar58, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA57)
                    .addComponent(numero55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar55, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtA56)
                    .addComponent(numero59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtA59)
                    .addComponent(numero56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(menos56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mais56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(zerar56, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        procuradoTxt.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        procuradoTxt.setForeground(new java.awt.Color(153, 153, 255));
        procuradoTxt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        procuradoTxt.setText("NÃO");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(procuradoTxt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(vermulta, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(procuradoTxt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
                            .addComponent(jLabel17, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jLabel14, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel12))
                            .addComponent(procuradoBt, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );

        check7.setBackground(new java.awt.Color(50, 31, 87));
        check7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        check7.setForeground(new java.awt.Color(255, 255, 255));
        check7.setSelected(true);
        check7.setText("ENVIAR DISCORD");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addContainerGap())))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 1040, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(check7, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void copiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copiarActionPerformed
        ...
        /*if(ide.length() < 1){
            ...
            String myString = comandos.getText();
    ...
    private void zerar11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar11ActionPerformed
        BotaoGeral("zer", 11);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar11ActionPerformed

    private void zerar12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar12ActionPerformed
        BotaoGeral("zer", 12);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar12ActionPerformed

    private void zerar16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar16ActionPerformed
        BotaoGeral("zer", 16);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar16ActionPerformed

    private void zerar17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar17ActionPerformed
        BotaoGeral("zer", 17);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar17ActionPerformed

    private void zerar18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar18ActionPerformed
        BotaoGeral("zer", 18);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar18ActionPerformed

    private void zerar19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar19ActionPerformed
        BotaoGeral("zer", 19);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar19ActionPerformed

    private void zerar14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar14ActionPerformed
        BotaoGeral("zer", 14);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar14ActionPerformed

    private void zerar20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar20ActionPerformed
        BotaoGeral("zer", 20);       // TODO add your handling code here:
    }//GEN-LAST:event_zerar20ActionPerformed

    private void zerar15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar15ActionPerformed
        BotaoGeral("zer", 15);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar15ActionPerformed
    ...
    private void numero53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero53ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero53ActionPerformed

    private void menos53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos53ActionPerformed
        BotaoGeral("rem", 53);        // TODO add your handling code here:
    }//GEN-LAST:event_menos53ActionPerformed

    private void mais53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais53ActionPerformed
          BotaoGeral("add", 53);       // TODO add your handling code here:
    }//GEN-LAST:event_mais53ActionPerformed

    private void zerar53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar53ActionPerformed
        BotaoGeral("zer", 53);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar53ActionPerformed

    private void menos54ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos54ActionPerformed
        BotaoGeral("rem", 54);        // TODO add your handling code here:
    }//GEN-LAST:event_menos54ActionPerformed

    private void numero54ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero54ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero54ActionPerformed

    private void mais54ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais54ActionPerformed
          BotaoGeral("add", 54);       // TODO add your handling code here:
    }//GEN-LAST:event_mais54ActionPerformed

    private void zerar54ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar54ActionPerformed
        BotaoGeral("zer", 54);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar54ActionPerformed

    private void menos57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos57ActionPerformed
        BotaoGeral("rem", 57);        // TODO add your handling code here:
    }//GEN-LAST:event_menos57ActionPerformed

    private void numero57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero57ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero57ActionPerformed

    private void mais57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais57ActionPerformed
          BotaoGeral("add", 57);       // TODO add your handling code here:
    }//GEN-LAST:event_mais57ActionPerformed

    private void zerar57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar57ActionPerformed
        BotaoGeral("zer", 57);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar57ActionPerformed

    private void menos58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos58ActionPerformed
        BotaoGeral("rem", 58);        // TODO add your handling code here:
    }//GEN-LAST:event_menos58ActionPerformed

    private void numero58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero58ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero58ActionPerformed

    private void mais58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais58ActionPerformed
          BotaoGeral("add", 58);       // TODO add your handling code here:
    }//GEN-LAST:event_mais58ActionPerformed

    private void zerar58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar58ActionPerformed
        BotaoGeral("zer", 58);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar58ActionPerformed

    private void menos59ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos59ActionPerformed
        BotaoGeral("rem", 59);        // TODO add your handling code here:
    }//GEN-LAST:event_menos59ActionPerformed

    private void menos55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos55ActionPerformed
        BotaoGeral("rem", 55);        // TODO add your handling code here:
    }//GEN-LAST:event_menos55ActionPerformed

    private void numero59ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero59ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero59ActionPerformed

    private void numero55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero55ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero55ActionPerformed

    private void mais59ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais59ActionPerformed
          BotaoGeral("add", 59);       // TODO add your handling code here:
    }//GEN-LAST:event_mais59ActionPerformed

    private void mais55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais55ActionPerformed
          BotaoGeral("add", 55);       // TODO add your handling code here:
    }//GEN-LAST:event_mais55ActionPerformed

    private void zerar59ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar59ActionPerformed
        BotaoGeral("zer", 59);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar59ActionPerformed

    private void zerar55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar55ActionPerformed
        BotaoGeral("zer", 55);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar55ActionPerformed

    private void menos56ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menos56ActionPerformed
        BotaoGeral("rem", 56);        // TODO add your handling code here:
    }//GEN-LAST:event_menos56ActionPerformed

    private void numero56ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numero56ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numero56ActionPerformed

    private void mais56ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mais56ActionPerformed
         BotaoGeral("add", 56);        // TODO add your handling code here:
    }//GEN-LAST:event_mais56ActionPerformed

    private void zerar56ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar56ActionPerformed
        BotaoGeral("zer", 56);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar56ActionPerformed

    private void check1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_check1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_check1ActionPerformed

    private void numero11KeyTyped1(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero11KeyTyped1
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero11KeyTyped1

    private void numero12KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero12KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero12KeyTyped

    private void numero11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero11KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();      // TODO add your handling code here:
    }//GEN-LAST:event_numero11KeyReleased

    private void numero13KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero13KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero13KeyReleased

    private void numero13KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero13KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero13KeyTyped

    private void numero14KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero14KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero14KeyTyped

    private void numero14KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero14KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero14KeyReleased

    private void numero15KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero15KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero15KeyTyped

    private void numero15KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero15KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();         // TODO add your handling code here:
    }//GEN-LAST:event_numero15KeyReleased

    private void numero16KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero16KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero16KeyTyped

    private void numero16KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero16KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero16KeyReleased

    private void numero17KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero17KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero17KeyTyped

    private void numero17KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero17KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero17KeyReleased

    private void numero18KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero18KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero18KeyTyped

    private void numero18KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero18KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero18KeyReleased

    private void numero19KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero19KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero19KeyTyped

    private void numero19KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero19KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero19KeyReleased

    private void numero20KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero20KeyTyped
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero20KeyTyped

    private void numero20KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero20KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes();        // TODO add your handling code here:
    }//GEN-LAST:event_numero20KeyReleased
    ...
    private void numero12KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numero12KeyReleased
        SomenteNumeros(evt);
        AtualizarCrimes(); 
    }//GEN-LAST:event_numero12KeyReleased

    private void zerar13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerar13ActionPerformed
    BotaoGeral("zer", 13);        // TODO add your handling code here:
    }//GEN-LAST:event_zerar13ActionPerformed
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        int id_usuario = Integer.parseInt(prenderDBarray.getString("passaporte"));
        ...
        for(int i3 = 0; i3 < procuradosDBarray.length(); i3++){
            ...
            int multaar = oproc.getInt("multas");
            int pagou = oproc.getInt("pagou");
            if(id_usuario==oproc.getInt("id_usuario")){
                if(pagou <= 0){
                    if(meseer > 0 || multaar > 0 || tornozer > 0){
                        proc_meses+=meseer;
                        proc_multas+=multaar;
        ...
        String CrimesFinal = "";
        if(proc_meses > 0) CrimesFinal+="Cárcere: "+proc_meses;
        if(proc_tornz > 0){
            if(!"".equals(CrimesFinal)) CrimesFinal+=", ";
            CrimesFinal+="Tornozeleira: "+proc_tornz;
        }
        if(proc_multas > 0){
            if(!"".equals(CrimesFinal)) CrimesFinal+=", ";
            CrimesFinal+="Multas: R$"+proc_multas;
        }
        if(!"".equals(CrimesFinal)){
            ...
            if(Escolha==JOptionPane.YES_OPTION){
                for(int i3 = 0; i3 < procuradosDBarray.length(); i3++){
                    ...
                    if(id_usuario==oproc.getInt("id_usuario")){
                        if(pagou <= 0){ // ||
                            if(meseer > 0) meserpresor+=meseer;
                            if(multaar > 0) multapresor+=multaar;
                            if(tornozer > 0) tornrpresor+=tornozer;
                            crimes.setText(crimes.getText()+" ////// "+oproc.getString("justificado"));
                            contrav.setText(contrav.getText()+" / "+oproc.getString("contravencoes"));
                            if(conexao.AttProcurados(id_usuario, Procol)){
                                System.out.println("Procurado do ID "+id_usuario+" setado no protocolo "+Procol);
                            }
                        }
                    }
                }
        ...
        my_obj.put("tornozeleira", tornrpresor+"");
        ...
        if(conexao.SalvarPrisao(my_obj)){
            showMessageDialog(null,
                prenderDBarray.getString("nome")+" foi registrado no banco da "+config.Abv_NomePolicia+" com o protocolo: "+Procol+" !",
                "Salvo com sucesso!!",
            ...
            if(check7.isSelected()){
                if(discorde){
                    if(bloqueado==0){
                        ...
                        showMessageDialog(null,prenderDBarray.getString("nome")+" bloqueou as notificações no discord. Portanto ele não recebeu a mensagem!",
                        "Notificações Bloqueadas!!",
                        JOptionPane.ERROR_MESSAGE);
                    }
                }else{
                    showMessageDialog(null,prenderDBarray.getString("nome")+" não possui discord vinculado. Portanto ele não recebeu a mensagem!",
        ...
        comandos.setText("/protocolo "+Protocolor);
    ...
    private void guardar_procuradoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar_procuradoActionPerformed
        ConexaoDB conexao = new ConexaoDB();
        ...
        my_obj.put("contravencoes", "Procurado ("+Procol+"):"+contrav.getText());
        ...
        my_obj.put("justificado", ProcStr+" //// "+crimes.getText());
        ...
        if(conexao.SalvarProcurado(my_obj)){
            showMessageDialog(null,
                prenderDBarray.getString("nome")+" foi registrado como procurado no banco da "+config.Abv_NomePolicia+" com o protocolo: "+Procol+" !",
                "Salvo com sucesso!!",
                JOptionPane.PLAIN_MESSAGE);
        }
        ...
        id.requestFocus();
    }//GEN-LAST:event_guardar_procuradoActionPerformed

    private void verpreso1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verpreso1ActionPerformed
        String m = JOptionPane.showInputDialog(this, "Digite a placa do veículo\nFormato: 12ABC345", "Pesquisa da Placa", JOptionPane.PLAIN_MESSAGE);
        if(m != null){
            if("".equals(m)){
                //this.closeIt();
                System.out.println("CAMPO VAZIO");
                JOptionPane.showMessageDialog(this, "Campo para a pesquisa da placa vazio. É necessário digitar a placa para efetuar a pesquisa.",
                    "ERRO NA PESQUISA DE PLACA",
                    JOptionPane.ERROR_MESSAGE);
            }else if(m.length() < 8){
                System.out.println("ABAIXO DO PERMITIDO DE CARACTERES");
                JOptionPane.showMessageDialog(this, "Poucos caracteres, siga o modelo: 12ABC345",
                    "ERRO NA PESQUISA DE PLACA",
                    JOptionPane.ERROR_MESSAGE);
            }else if(m.length() > 8){
                System.out.println("ACIMA DO PERMITIDO DE CARACTERES");
                JOptionPane.showMessageDialog(this, "Muitos caracteres, siga o modelo: 12ABC345",
                    "ERRO NA PESQUISA DE PLACA",
                    JOptionPane.ERROR_MESSAGE);
            }else if(m.length() == 8){
                if(SetarIDPesquisa(m)){
                    System.out.println("DEU CERTO");
                }else{
                    System.out.println("NADA ENCONTRADO NO REGISTRO "+m);
                    JOptionPane.showMessageDialog(this, "Não encontramos ninguém na placa "+m,
                    "ERRO NA PESQUISA DE PLACA",
                    JOptionPane.ERROR_MESSAGE);
                }
            }else{
            ...
            System.out.println("Pesquisa da placa retornou: "+m.toString());
        }
    }//GEN-LAST:event_verpreso1ActionPerformed
    ...
    public boolean SetarIDPesquisa(String registroRG){
        for(int i = 0; i < usuariosDBarray.length(); i++){
            JSONObject usu = usuariosDBarray.getJSONObject(i);
            //System.out.println("user_id: "+usu.getInt("id_usuario")+" / registration: "+usu.getString("registration"));
            if(registroRG.contains(usu.getString("registration"))){
                id.setText(usu.getInt("id_usuario")+"");
                AttInfo();
                return true;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prender.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton guardar_procurado;
    ...
    private javax.swing.JButton mais53;
    private javax.swing.JButton mais54;
    private javax.swing.JButton mais55;
    private javax.swing.JButton mais56;
    private javax.swing.JButton mais57;
    private javax.swing.JButton mais58;
    private javax.swing.JButton mais59;
    ...
    private javax.swing.JButton menos53;
    private javax.swing.JButton menos54;
    private javax.swing.JButton menos55;
    private javax.swing.JButton menos56;
    private javax.swing.JButton menos57;
    private javax.swing.JButton menos58;
    private javax.swing.JButton menos59;
    ...
    private javax.swing.JTextField numero13;
    private javax.swing.JTextField numero14;
    private javax.swing.JTextField numero15;
    private javax.swing.JTextField numero16;
    private javax.swing.JTextField numero17;
    private javax.swing.JTextField numero18;
    private javax.swing.JTextField numero19;
    ...
    private javax.swing.JTextField numero53;
    private javax.swing.JTextField numero54;
    private javax.swing.JTextField numero55;
    private javax.swing.JTextField numero56;
    private javax.swing.JTextField numero57;
    private javax.swing.JTextField numero58;
    private javax.swing.JTextField numero59;
    ...
    private javax.swing.JLabel procuradoTxt;
    ...
    private javax.swing.JLabel txtA14;
    ...
    private javax.swing.JLabel txtA19;
    private javax.swing.JLabel txtA2;
    private javax.swing.JLabel txtA20;
    private javax.swing.JLabel txtA21;
    private javax.swing.JLabel txtA22;
    private javax.swing.JLabel txtA23;
    private javax.swing.JLabel txtA24;
    private javax.swing.JLabel txtA25;
    private javax.swing.JLabel txtA26;
    private javax.swing.JLabel txtA27;
    ...
    private javax.swing.JLabel txtA52;
    private javax.swing.JLabel txtA53;
    private javax.swing.JLabel txtA54;
    private javax.swing.JLabel txtA55;
    private javax.swing.JLabel txtA56;
    private javax.swing.JLabel txtA57;
    private javax.swing.JLabel txtA59;
    ...
    private javax.swing.JButton verpreso1;
    private javax.swing.JButton zerar1;
    private javax.swing.JButton zerar10;
    private javax.swing.JButton zerar11;
    private javax.swing.JButton zerar12;
    private javax.swing.JButton zerar13;
    private javax.swing.JButton zerar14;
    private javax.swing.JButton zerar15;
    private javax.swing.JButton zerar16;
    private javax.swing.JButton zerar17;
    private javax.swing.JButton zerar18;
    private javax.swing.JButton zerar19;
    private javax.swing.JButton zerar2;
    private javax.swing.JButton zerar20;
    ...
    private javax.swing.JButton zerar53;
    private javax.swing.JButton zerar54;
    private javax.swing.JButton zerar55;
    private javax.swing.JButton zerar56;
    private javax.swing.JButton zerar57;
    private javax.swing.JButton zerar58;
    private javax.swing.JButton zerar59;
